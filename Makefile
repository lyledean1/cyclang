...
build-stdlib:
	cd crates/cyclang-backend/src/compiler/codegen/stdlib && clang -c -emit-llvm export.c -o export.bc

build-stdlib-ir:
	cd crates/cyclang-backend/src/compiler/codegen/stdlib && clang -S -emit-llvm export.c -o export.ll
