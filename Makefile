...
build-stdlib:
	cd crates/cyclang-backend/src/compiler/codegen/stdlib && clang -c -emit-llvm -O0 types.c -o types.bc

build-stdlib-ir:
	cd crates/cyclang-backend/src/compiler/codegen/stdlib && clang -S -emit-llvm -O0 types.c -o types.ll
