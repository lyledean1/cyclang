...
@target.wasm.cpu.generic = internal unnamed_addr constant %target.Target.Cpu.Model { { ptr, i32 } { ptr @target.wasm.cpu.generic__anon_423, i32 7 }, { ptr, i32 } { ptr @target.wasm.cpu.generic__anon_423, i32 7 }, %target.Target.Cpu.Feature.Set { [9 x i32] [i32 544, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0] } }, align 4
@target.wasm.cpu.generic__anon_423 = internal unnamed_addr constant [8 x i8] c"generic\00", align 1
...
@main.boolToStrZig__anon_780 = internal unnamed_addr constant [5 x i8] c"true\00", align 1
@main.boolToStrZig__anon_781 = internal unnamed_addr constant [6 x i8] c"false\00", align 1
@builtin.panic_messages.integer_overflow__anon_812 = internal unnamed_addr constant [17 x i8] c"integer overflow\00", align 1
@0 = private unnamed_addr constant { i32, i8, [3 x i8] } { i32 undef, i8 0, [3 x i8] undef }, align 4
@builtin.panic_messages.integer_overflow = internal unnamed_addr constant ptr @builtin.panic_messages.integer_overflow__anon_812, align 4
...
@cyclang_stdlib.boolToStrZig = alias ptr (i1), ptr @boolToStrZig
...
2:                                                ; preds = %1
  ret ptr @main.boolToStrZig__anon_780

3:                                                ; preds = %1
  ret ptr @main.boolToStrZig__anon_781
}
...
5:                                                ; preds = %2
  call fastcc void @builtin.default_panic(ptr @builtin.panic_messages.integer_overflow__anon_812, i32 16, ptr null, ptr @0)
  unreachable
