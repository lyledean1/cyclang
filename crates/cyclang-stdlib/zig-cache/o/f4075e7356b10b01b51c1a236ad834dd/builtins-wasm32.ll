...
@main.boolToStrZig__anon_772 = internal unnamed_addr constant [5 x i8] c"true\00", align 1
@main.boolToStrZig__anon_773 = internal unnamed_addr constant [6 x i8] c"false\00", align 1
@builtin.panic_messages.integer_overflow__anon_804 = internal unnamed_addr constant [17 x i8] c"integer overflow\00", align 1
@0 = private unnamed_addr constant { i32, i8, [3 x i8] } { i32 undef, i8 0, [3 x i8] undef }, align 4
@builtin.panic_messages.integer_overflow = internal unnamed_addr constant ptr @builtin.panic_messages.integer_overflow__anon_804, align 4
...
2:                                                ; preds = %1
  ret ptr @main.boolToStrZig__anon_772

3:                                                ; preds = %1
  ret ptr @main.boolToStrZig__anon_773
}
...
5:                                                ; preds = %2
  call fastcc void @builtin.default_panic(ptr @builtin.panic_messages.integer_overflow__anon_804, i32 16, ptr null, ptr @0)
  unreachable
